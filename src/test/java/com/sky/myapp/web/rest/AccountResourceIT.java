...
import static com.sky.myapp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import com.sky.myapp.IntegrationTest;
import com.sky.myapp.config.Constants;
import com.sky.myapp.domain.PersistentToken;
import com.sky.myapp.domain.User;
import com.sky.myapp.repository.AuthorityRepository;
...
import com.sky.myapp.web.rest.vm.KeyAndPasswordVM;
