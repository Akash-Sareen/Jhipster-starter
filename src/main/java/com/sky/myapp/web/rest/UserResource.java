...
import com.sky.myapp.service.MailService;
...
import com.sky.myapp.web.rest.errors.EmailAlreadyUsedException;
import com.sky.myapp.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
 ...
 * <p>
 * This class accesses the {@link com.sky.myapp.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
     ...
     */
    @PostMapping("/users")
    @PreAuthorize("hasAuthority(\"" + PrivilegesConstants.PRIVILEGE_ADMIN + "\")")
